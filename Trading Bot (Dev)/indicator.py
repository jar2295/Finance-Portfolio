...
class Indicators():
    ...
    #numeric threshhold and operator that must be passed to buy/sell
    ...
    def ema(self, period: int, alpha: float = 0)-> pd.DataFrame:
    ...
    def refresh(self):
        ...
        #loop through all of the stored indicators
